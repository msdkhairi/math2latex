...
from .positional_encoding2 import PositionalEncoding1D, PositionalEncoding2D
...
class ResNetTransformer(nn.Module):
    def __init__(
        ...
        transformer_decoder_layer = nn.TransformerDecoderLayer(self.d_model, num_heads, dim_feedforward, dropout)
